...
return (
    <div className="flex items-center justify-between text-sm bg-white py-4 mb-5 border-b-gray-400 shadow-md">
      <img onClick={()=>{navigate('/')}} className="w-44 cursor-pointer" src={assets.logo} alt="" />
      <ul className="hidden md:flex gap-5 items-start font font-medium">
        <NavLink to="/">
          <li className="py-1">
            Home
