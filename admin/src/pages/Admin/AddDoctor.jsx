      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Experience </p>
              <select value={experiance} onChange={(e)=>setExperiance(e.target.value)} className="border rounded px-3 py-2">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Fees</p>
              <input value={fees} onChange={(e)=>setFees(e.target.value)} className="border rounded px-3 py-2" type="number" placeholder="Fees" />
            </div>
          </div>
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Education</p>
              <input value={degree} onChange={(e)=>setDegree(e.target.value)} className="border rounded px-3 py-2" type="text" placeholder="Education" />
            </div>
        ...
        <div>
          ...
          <textarea value={about} onChange={(e)=>setAbout(e.target.value)} className="w-full px-4 pt-2 border rounded" placeholder="Write About Doctor" rows={5} />
        </div>
